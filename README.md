...
Additionally, you will need a reset firmware (settings_reset-ergohaven-zmk.uf2). Usually, it can be found in the same place as the main firmware, or in our [keymap_hub](https://github.com/ergohaven/keymap_hub).
